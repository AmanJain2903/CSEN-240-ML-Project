...
Original file is located at
    https://colab.research.google.com/drive/1KHWDKWI_C5o_v_gZdIKxQ-0e2nTO5dlM
...
# model = tf.keras.models.load_model('KerasModels/Xception.keras')
...
model.save('KerasModels/Xception.keras')